...
<div class="row">
  <div class="col-md-3">
    ...
    <div class="col-md-6">
    <form id="loginForm" action="validarCode.py" method="POST" role="form" class="border border-light p-5" style="background-color: #47a5b4;">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="myform-bottom">
            <form role="form" action="./Admin/inicio.py" method="post">
              ...
              <div class="text-center">
                <h6>¿Olvido su
                  <a href="Recordar.py" style="color: #ffffff;">Contraseña</a>
                  ?
                </h6>
              </div>
              <div class="text-center">
                <h6>¿No esta Registrado?
                  <a href="Registrar.py" style="color: #ffffff;">Registrarme</a>
                </h6>
              </div>
              <br/>
              <center>
