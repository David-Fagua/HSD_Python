...
<head>
	...
	<?py include 'partials/head.py';?>
  <?py include 'partials/menu.py';?>
...
<div class="container">
  ...
  <div class="carousel-item">
    ...
    <div class="carousel-item">
      <img src="assets/img/8.jpg" width="100" height="400px " class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
...
<div class="container">
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.py" class="lead">este tipo de hilo sirve para cualquier tipo de costura pero es muy aconsejado para coser a mano, ya que es suave y fácil de sacar y romper.</h6>
  ...
  <div class="col-md-3 order-md-1">
    <img src="assets/img/11.jpg" class="card-img-top" alt="assets/img">
  </div>
</div>
</br>
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.py" class="lead"> usado para coser seda y otras telas delicadas ofrece una variedad cromática muy limitada. Ideal para bordados. Su precio es más elevado que el resto.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="col-md-3 order-md-1">
    <img src="assets/img/2.jpg" class="card-img-top" alt="assets/img">
  </div>
</div>
</br>
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.py" class="lead">elásticos y por norma general fabricados con poliéster. Existen modelos también de algodón y fibra sintética. Este tipo es de los más resistentes para todo tipo de telas.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="col-md-3 order-md-1">
    <img src="assets/img/3.jpg" class="card-img-top" alt="assets/img">
  </div>
</div>
</br>
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.py" class="lead">este tipo de hilo es ideal para coser lana, algodón y tiene un tono brillante. Sirven para coser tanto a máquina como a mano. Este tipo de hilo es mucho más resistente a los lavados y planchados.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="col-md-3 order-md-1">
    <img src="assets/img/4.jpg" class="card-img-top" alt="assets/img">
  </div>
</div>

</br>
  
<?py include 'partials/menufinal.py';?>
<?py include 'partials/footer.py';?>
